...
const CadetVideoStepWise: FC<{
  ...
  return (
    <div
      className={cn(
        'CadetVideoStepWise m-0 mb-2 flex h-full w-full flex-col justify-stretch rounded-lg bg-card pl-2 pr-2 pt-2 text-card-foreground shadow-sm',
        className,
      )}
    >
...
CadetVideoStepWise.displayName = 'CadetVideoStepWise'
export default CadetVideoStepWise
