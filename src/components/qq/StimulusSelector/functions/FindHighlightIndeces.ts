...
//     // highlight is a string
//     if (typeof element === 'string') {
//       let matches = findWholeWordPositions(sentence, element)
//       // let matches = findIndexes(sentence, element)
//       if (matches.length == 1) {
//         return Math.abs(matches[0].index - caretOffset)
//       } else if (matches.length > 1) {
//         // find the closest match
//         let closest = Infinity
//         for (let i = 0; i < matches.length; i++) {
//           let distance = Math.abs(matches[i].index - caretOffset)
//           if (distance < closest) {
//             closest = distance
//           }
//         }
...
//     //  highlight is an array of two strings
//     else if (Array.isArray(element)) {
//       let matches0 = findWholeWordPositions(sentence, element[0])
//       let matches1 = findWholeWordPositions(sentence, element[1])
//       // let matches0 = findIndexes(sentence, element[0])
//       // let matches1 = findIndexes(sentence, element[1])
...
//         let closest0 = Infinity
//         for (let i = 0; i < matches0.length; i++) {
//           let distance = Math.abs(matches0[i].index - caretOffset)
//           if (distance < closest0) {
//             closest0 = distance
//           }
//         }
...
//         let closest1 = Infinity
//         for (let i = 0; i < matches1.length; i++) {
//           let distance = Math.abs(matches1[i].index - caretOffset)
//           if (distance < closest1) {
//             closest1 = distance
//           }
//         }
...
//   // Now find the start and end of the highlight
//   if (typeof bestHighlight === 'string') {
//     let matches = findWholeWordPositions(sentence, bestHighlight)
//     // let matches = findIndexes(sentence, bestHighlight)
//     if (matches.length == 1) {
...
//     let start0 = 0,
//       end0 = 0
//     let matches0 = findWholeWordPositions(sentence, bestHighlight[0])
//     // let matches0 = findIndexes(sentence, bestHighlight[0])
//     let closest0 = Infinity
//     for (let i = 0; i < matches0.length; i++) {
//       let distance = Math.abs(matches0[i].index - caretOffset)
...
//     let start1 = 0,
//       end1 = 0
//     let matches1 = findWholeWordPositions(sentence, bestHighlight[1])
//     // let matches1 = findIndexes(sentence, bestHighlight[1])
//     let closest1 = Infinity
//     for (let i = 0; i < matches1.length; i++) {
//       let distance = Math.abs(matches1[i].index - caretOffset)
